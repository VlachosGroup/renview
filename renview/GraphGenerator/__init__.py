...
def print_header(fname, Rank_Sep, Node_Sep, title):
    '''
...
def print_header_species(fname, Rank_Sep, Node_Sep, title):
    '''
...
def generate_visualizations(title):
    '''
    ...
    filename_svg = os.path.join(str(output_directory_name),
                                str(pre) + '.svg')
    print_header(filename, Rank_Sep, Node_Sep, title=title)
    f = open(filename, "a+")
    ...
    for i in range(len(openmkm_species_list)):
        ...
        print_header_species(fname, Rank_Sep, Node_Sep, title=title)
        f = open(fname, "a+")
